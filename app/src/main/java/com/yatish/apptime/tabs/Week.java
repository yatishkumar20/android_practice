...
public class Week extends Fragment {
    ...
    public void init(View v) {
        ...
        new WeekAsyncTask().execute();

        mLayoutManager = new LinearLayoutManager(getContext());

        mRecyclerView.setLayoutManager(mLayoutManager);
        mAdapter = new MyAppAdapter(getContext(), new ArrayList<Apps>(),"week");
    ...
    class WeekAsyncTask extends AsyncTask<String,Void, List<Apps>>{
        @Override
        ...
        protected void onPostExecute(List<Apps> appses) {
                ...
                mAdapter = new MyAppAdapter(getContext(), appses,"week");
                mRecyclerView.setAdapter(mAdapter);
